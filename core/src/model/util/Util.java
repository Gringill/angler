...
public class Util {
    ...
    public static Vector2 getMouseWorldCoords(Gameplay gameplay, Vector2 localMouse, boolean doFlipY) {
...
//    public static Vector2 getMouseWorldCoords(Point localMouse, boolean doFlipY) {
...
//    }
    ...
    public static Vector2 getCamBottomLeft(OrthographicCamera camera) {
    ...
    public static void drawRect(SpriteBatch batch, int x, int y, int width, int height, int thickness) {
    ...
    public static void drawLine(SpriteBatch batch, int x1, int y1, int x2, int y2, int thickness) {
        int dx = x2-x1;
        int dy = y2-y1;
    ...
    public static void setRectSprite(Sprite rectSprite) {
        Util.rectSprite = rectSprite;
    }
