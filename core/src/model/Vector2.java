...
public class Vector2 extends com.badlogic.gdx.math.Vector2 {
    ...
    public static final short RELATE_CLOCKWISE = -1;
    public static final short RELATE_COUNTERCLOCKWISE = 1;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Math.toDegrees(v.getAngleTowards(v2)));
    }
    ...
    public double getAngleTowards(Vector2 v2) {
        return Math.atan2(v2.y - y, v2.x - x);
    }

    public double getDeltaFacing(Vector2 v) {
