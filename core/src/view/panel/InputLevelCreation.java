...
public class InputLevelCreation extends JPanel {
	...
	public InputLevelCreation(Editor editor) {
		...
		int result = JOptionPane.showConfirmDialog(null, this, "New level...", JOptionPane.OK_CANCEL_OPTION);
		if (result == JOptionPane.OK_OPTION) {
			Level l = Level.createLevel(editor, input_name.getText(), Integer.valueOf(input_width.getText()), Integer.valueOf(input_height.getText()));
			editor.openLevel(l);
		}
	}
}
